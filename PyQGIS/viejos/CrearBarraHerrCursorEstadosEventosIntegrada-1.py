...
from qgis.core import QgsProject, QgsVectorLayer, QgsField, QgsFeature, QgsGeometry, QgsPoint
    ...
    def canvasPressEvent(self, event):
        ...
        if event.button() == Qt.LeftButton:
            ...
            if estado_flujo_trabajo == "selección":
                ...
                self.node_layer.addFeature(node_feature)
...
# Crear una instancia de la capa de nodos
