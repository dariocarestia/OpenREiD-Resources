        ...
        if event.button() == Qt.LeftButton:
            ...
            if estado_flujo_trabajo == "selección":
                ...
                if field_name in self.node_layer.fields().names():
                    ...
                    # Asegurarte de obtener el valor del atributo "id" correctamente
                    id_attribute_index = self.node_layer.fields().indexFromName("id")
                    unique_node_id = str(uuid.uuid4())
                    
                    # Establecer el valor del atributo "id" en la característica
                    node_feature.setAttribute(id_attribute_index, unique_node_id)
