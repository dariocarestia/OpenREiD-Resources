    ...
    def canvasMoveEvent(self, event):
        ...
        if estado_flujo_trabajo == "linea":
            ...
            if nearby_nodes:
                ...
                nearest_node = self.node_layer.getFeature(nearest_node_id)
...
#     max_distance = 0.0003
#     nearby_nodes = spatial_index.nearestNeighbor(target_point, 1, max_distance)
...
#     rect = QgsRectangle(target_point.x() - 0.0003, target_point.y() - 0.0003, target_point.x() + 0.0003, target_point.y() + 0.0003)

#     # Realizar una selección basada en la ubicación del punto objetivo
#     node_layer.selectByRect(rect, True)
...
#         nearest_node = min(selected_nodes, key=lambda node: node.geometry().distance(target_point))
#         return nearest_node
