...
pv_symbol = QgsSymbol.defaultSymbol(pv_system_layer.geometryType())  # Crear un nuevo símbolo y añadir la capa de marcador SVG
pv_symbol.changeSymbolLayer(0, pv_svg_marker)
