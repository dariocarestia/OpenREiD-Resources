...
node_mt_layer = QgsVectorLayer("Point?crs=EPSG:4326", "nodos_mt", "memory")
...
node_bt_layer = QgsVectorLayer("Point?crs=EPSG:4326", "nodos_bt", "memory")
...
line_mt_layer = QgsVectorLayer("LineString?crs=EPSG:4326", "lineas_mt", "memory")
line_mt_layer_provider = line_mt_layer.dataProvider()
line_mt_layer_provider.addAttributes([QgsField("id", QVariant.String), QgsField("start_node", QVariant.String), QgsField("end_node", QVariant.String)])
...
line_bt_layer = QgsVectorLayer("LineString?crs=EPSG:4326", "lineas_bt", "memory")
