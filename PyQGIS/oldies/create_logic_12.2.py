...
class CustomMapTool(QgsMapTool):
    ...
    def show_edit_form_line(self, element, layer):
        ...
        general_layout.addRow("Nodo inicial:", self.start_node_edit)
        general_layout.addRow("Fases iniciales:", self.start_ph_edit)
        general_layout.addRow("Nodo final:", self.end_node_edit)
        general_layout.addRow("Fases finales:", self.end_ph_edit)
        general_layout.addRow("Longitud (m):", self.length_edit)
        general_layout.addRow("Unidades:", self.units_edit)
        general_layout.addRow("Fases:", self.phases_edit)
