...
class CustomMapTool(QgsMapTool):
    ...
    def startNodeMovement(self, node_id):
        ...
        self.associated_lines = [feat for feat in self.line_mt_layer.getFeatures() if feat['start_node'] == node_id or feat['end_node'] == node_id]
