...
class CustomMapTool(QgsMapTool):
    ...
    # def show_edit_form_load(self, feature, layer):
    #     dialog = QDialog()
    #     dialog.setWindowTitle("Editar Carga")

    #     layout = QFormLayout()

    #     field_name = QLineEdit(str(feature["id"]))
    #     field_kw = QLineEdit(str(feature["kw"]))
    #     field_pf = QLineEdit(str(feature["pf"]))

    #     layout.addRow("Nombre:", field_name)
    #     layout.addRow("Potencia activa (kW):", field_kw)
    #     layout.addRow("Factor de potencia (pf):", field_pf)
    ...
    #     def guardar():
    #         layer.startEditing()
    #         feature["id"] = field_name.text()
    #         feature["kw"] = float(field_kw.text())
    #         feature["pf"] = float(field_pf.text())
    #         layer.updateFeature(feature)
    #         layer.commitChanges()
    #         dialog.accept()

    #     save_button.clicked.connect(guardar)
