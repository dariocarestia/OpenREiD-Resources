...
class CustomToolbarPanel:
    def __init__(self, map_tool, node_mt_layer, node_bt_layer, line_mt_layer, line_bt_layer, generator_layer, load_layer, switch_layer, transformer_layer, et_layer, seta_layer, capacitor_layer):
        self.toolbox = None
        self.tool_buttons = []
    ...
    def handle_button_click(self, button_name, cursor_icon_path):
        ...
        if button_name.lower() == "seleccion":
            ...
            estado_edicion = "Selec_None"
            iface.mapCanvas().unsetCursor()
            import_dss(self.map_tool.node_mt_layer, self.map_tool.line_mt_layer, self.map_tool.transformer_layer, self.map_tool.et_layer, self.map_tool.load_layer, self.map_tool.switch_layer)
    
        elif  button_name.lower() == "dss-export":
            estado_flujo_trabajo = "dss-export"
            estado_edicion = "Selec_None"
            iface.mapCanvas().unsetCursor()
            export_dss(self.map_tool.node_mt_layer, self.map_tool.line_mt_layer, self.map_tool.transformer_layer, self.map_tool.et_layer, self.map_tool.load_layer, self.map_tool.switch_layer)
...
class CustomMapTool(QgsMapTool):
    def __init__(self, canvas, node_mt_layer, node_bt_layer, line_mt_layer, line_bt_layer, generator_layer, load_layer, switch_layer, transformer_layer, et_layer, seta_layer, capacitor_layer):
...
def import_dss(node_mt_layer, line_layer, transformer_layer, et_layer, load_layer, switch_layer):
    ...
    total_elements = node_count + line_count + transformer_count + load_count + relay_count + vsource_count + capacitor_count + generator_count
...
def export_dss(node_mt_layer, line_layer, transformer_layer, et_layer, load_layer, switch_layer):
...
custom_map_tool = CustomMapTool(iface.mapCanvas(), node_mt_layer, node_bt_layer, line_mt_layer, line_bt_layer, generator_layer, load_layer, switch_layer, transformer_layer, et_layer, seta_layer, capacitor_layer)
iface.mapCanvas().setMapTool(custom_map_tool)

# Crear una instancia de la clase y mostrar la caja de herramientas
custom_toolbar_panel = CustomToolbarPanel(custom_map_tool, node_mt_layer, node_bt_layer, line_mt_layer, line_bt_layer, generator_layer, load_layer, switch_layer, transformer_layer, et_layer, seta_layer, capacitor_layer)
