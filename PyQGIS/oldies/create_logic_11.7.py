...
class CustomToolbarPanel:
    ...
    def init_panel(self):
        ...
        button_names = [
            ...
            ("PowerFlow", "Calcular flujo de potencia Instantáneo")
        ]
        ...
        def create_handler(button_name, cursor_icon_path):
            def handler():
                if button_name.lower() == "librerias":
                    ...
                    # Crear el menú desplegable para PowerFlow
                    menu = QMenu()
                    ...
                    # Mostrar el menú debajo del botón
                    button = next((btn for btn in self.tool_buttons if btn.objectName() == "powerflow"), None)
                    if button:
                        menu.exec_(button.mapToGlobal(button.rect().bottomLeft()))
                else:
