...
class CustomToolbarPanel:
    ...
    def handle_button_click(self, button_name, cursor_icon_path):
        ...
        if button_name.lower() == "seleccion":
            ...
            export_dss_location(folder_path, self.map_tool.node_mt_layer, self.map_tool.line_mt_layer, self.map_tool.transformer_layer, self.map_tool.generator_layer, self.map_tool.pv_system_layer , self.map_tool.et_layer, self.map_tool.load_layer, self.map_tool.switch_layer, self.map_tool.capacitor_layer)
...
def power_flow(node_mt_layer, line_mt_layer, load_layer):
    ...
    export_dss_location(power_flow_dir, node_mt_layer, line_mt_layer, transformer_layer, generator_layer, pv_system_layer, et_layer, load_layer, switch_layer, capacitor_layer)
...
def export_dss_location(export_dir, node_mt_layer, line_layer, transformer_layer, generator_layer, pv_system_layer, et_layer, load_layer, switch_layer, capacitor_layer):
    ...
    create_vsource_dss(et_layer, export_dir, progress, progress_level, increment_per_element)
    messageLabel.setText("Exportando líneas...")
    create_line_dss(line_layer, export_dir, progress, progress_level, increment_per_element)
    messageLabel.setText("Exportando transformadores...")
    create_transformer_dss(transformer_layer, export_dir, progress, progress_level, increment_per_element)
    messageLabel.setText("Exportando cargas...")
    create_load_dss(load_layer, export_dir, progress, progress_level, increment_per_element)
    messageLabel.setText("Exportando interruptores...")
    create_switch_dss(switch_layer, export_dir, progress, progress_level, increment_per_element)
    messageLabel.setText("Exportando capacitores...")
    create_capacitor_dss(capacitor_layer, export_dir, progress, progress_level, increment_per_element)
    messageLabel.setText("Exportando sistemas fotovoltaicos...")
    create_pv_system_dss(pv_system_layer, export_dir, progress, progress_level, increment_per_element)
    messageLabel.setText("Exportando generadores...")
    create_generator_dss(generator_layer, export_dir, progress, progress_level, increment_per_element)
    messageLabel.setText("Exportando coordenadas de nodos...")
    create_buscoords_csv(node_mt_layer, export_dir, progress, progress_level, increment_per_element)
    ...
    linecode_layers = QgsProject.instance().mapLayersByName("linecode")
    if linecode_layers:
        create_linecode_dss(linecode_layers[0], export_dir, messageLabel, progress, progress_level, increment_per_element)
    ...
    if linegeometry_layers:
        create_linegeometry_dss(linegeometry_layers[0], export_dir, messageLabel, progress, progress_level, increment_per_element)
    ...
    if linespacing_layers:
        create_linespacing_dss(linespacing_layers[0], export_dir, messageLabel, progress, progress_level, increment_per_element)
    ...
    if wiredata_layers:
        create_wiredata_dss(wiredata_layers[0], export_dir, messageLabel, progress, progress_level, increment_per_element)
