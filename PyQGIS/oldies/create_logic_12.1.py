...
class CustomMapTool(QgsMapTool):
    ...
    def show_edit_form_line(self, element, layer):
        ...
        self.rb_params = QRadioButton("Parámetros eléctricos")
        ...
        # GroupBox de parámetros eléctricos
        self.gb_params = QGroupBox("Parámetros eléctricos")
        params_layout = QFormLayout(self.gb_params)
        
        # Crear campos de parámetros eléctricos
        ...
        # Agregar campos al layout de parámetros
        params_layout.addRow("r1 (Ω/km):", self.r1_edit)
        params_layout.addRow("r0 (Ω/km):", self.r0_edit)
        params_layout.addRow("x1 (Ω/km):", self.x1_edit)
        params_layout.addRow("x0 (Ω/km):", self.x0_edit)
        params_layout.addRow("c1 (nF/km):", self.c1_edit)
        params_layout.addRow("c0 (nF/km):", self.c0_edit)
        ...
        # Agregar groupboxes al layout principal
