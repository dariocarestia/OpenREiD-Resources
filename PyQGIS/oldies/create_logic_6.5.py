...
def export_dss(node_mt_layer, line_layer, transformer_layer, et_layer, load_layer, switch_layer):
    ...
    create_vsource_dss(et_layer, folder_path)
    create_line_dss(line_layer, folder_path)
    create_transformer_dss(transformer_layer, folder_path)
    create_load_dss(load_layer, folder_path)
    create_switch_dss(switch_layer, folder_path)
