...
from PyQt5.QtWidgets import QToolBar, QToolButton, QButtonGroup, QAction, QActionGroup, QFileDialog, QComboBox, QDialog, QVBoxLayout, QDialogButtonBox, QMenu, QFormLayout, QLineEdit, QPushButton, QDialogButtonBox
...
def power_flow(node_mt_layer, line_mt_layer, load_layer):
    ...
    for line in line_mt_layer.getFeatures():
        ...
        p_activa = abs(dss_instance.dssCktElement.Powers[0])  # Obtener el valor de P.Activa
    ...
    for load in load_layer.getFeatures():
        ...
        p_activa = abs(dss_instance.dssCktElement.Powers[0])  # Obtener el valor de P.Activa
        p_reactiva = abs(dss_instance.dssCktElement.Powers[1])  # Obtener el valor de P.Reactiva
        p_activa = round(p_activa, 3)  # Restringir a 3 dígitos decimales
